...
if(contains(river,'White'))
    ...
    load('WR_historical_data_MPI.mat'); 
    historical_data = WR_historical_data_MPI; 
    load('WR_future_data_MPI.mat'); 
    future_data = WR_future_data_MPI; 
...
elseif(contains(river,'Shenandoah')) 
    ...
    load('SR_historical_data_MPI.mat'); 
    historical_data = SR_historical_data_MPI; 
    load('SR_future_data_MPI.mat'); 
    future_data = SR_future_data_MPI; 
    acronym = 'SR';
...
elseif(contains(river,'Mattawamkeag'))
    ...
    load('MR_historical_data_MPI.mat'); 
    historical_data = MR_historical_data_MPI; 
    load('MR_future_data_MPI.mat'); 
    future_data = MR_future_data_MPI;     
    acronym = 'MR'; 
...
elseif(contains(river, 'Diamond'))
    ...
    load('DR_historical_data_MPI.mat'); 
    historical_data = DR_historical_data_MPI; 
    load('DR_future_data_MPI.mat'); 
    future_data = DR_future_data_MPI; 
    acronym = 'DR';
...
save(strcat(acronym, '_snowdepth_avg_predictions_MPI.mat'), 'regressed_snow_avg');
...
save(strcat(acronym, '_snowdepth_avg_WRFhist_MPI.mat'), 'regressed_snow_WRFhist_avg'); 
save(strcat(acronym, '_snowdepth_avg_WRFfut_MPI.mat'), 'regressed_snow_WRFfut_avg'); 
