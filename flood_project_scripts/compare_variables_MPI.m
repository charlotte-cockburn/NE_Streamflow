...
saveas(winter_hist_fig, strcat(acronym, '_RFvars_percchange_win_MPI.png')); 
...
perc_change = (nanmean(this_data_fut)-nanmean(this_data_hist));%/...
    %abs(nanmean(this_data_hist));
perc_change = round(perc_change,4);%*100;
p = histogram(this_data_hist, 'BinWidth', bin_width); 
hold on;
p2 = histogram(this_data_fut, 'BinWidth', bin_width); 
ks_all = kstest2(this_data_hist, this_data_fut); 
...
saveas(summer_hist_fig, strcat(acronym, '_RFvars_percchange_sum_MPI.png')); 
...
saveas(cs_top2_fig, strcat(acronym, '_RFvars_top2_win_MPI.png')); 
...
saveas(ws_top2_fig, strcat(acronym, '_RFvars_top2_sum_MPI.png')); 
